...
export default function OrificeRun() {
    ...
    const [orificeUnit, setOrificeUnit] = React.useState("mm");
        ...
        <ScrollView style={styles.body} contentContainerStyle={{ paddingBottom: 60 }}>
            <View style={styles.header}>
                <Link href="/" style={styles.backButton}>
                    ...
                    <Text style={styles.headerTitle}>Orifice Meter</Text>
                </Link>
            </View>
            <View style={styles.card}>
                ...
                <View style={styles.inputGroup}>
                    <Text style={styles.label}>Orifice Diameter</Text>
                    <View style={styles.inputRow}>
                        <TextInput style={styles.input} placeholder="Enter orifice diameter" keyboardType="numeric" />
                        <Picker selectedValue={orificeUnit} style={styles.unitPicker} onValueChange={(itemValue) => setOrificeUnit(itemValue)}>
                            <Picker.Item label="m" value="m" />
                            <Picker.Item label="cm" value="cm" />
                            <Picker.Item label="mm" value="mm" />
                        </Picker>
            ...
            <View style={styles.card}>
                ...
                <Text style={{ marginTop: 12 }}>Co vs NRe</Text>
                <View style={styles.graphContainer}>
                    <Text>Graph will appear here</Text>
                </View>
            </View>
